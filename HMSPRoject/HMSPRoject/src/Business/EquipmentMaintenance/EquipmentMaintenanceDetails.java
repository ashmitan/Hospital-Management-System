 ...
 * @author Ashmita
 */
public class EquipmentMaintenanceDetails {
   private String firstName; 
    ...
    private WorkQueueDirectory workQueueDirectory;
  ...
  public String PopulateSalary(String designation)
  {
   ...
   return employee.getSalary();   
    ...
    public WorkQueueDirectory getWorkQueueDirectory() {
        return workQueueDirectory;
    }

    public void setWorkQueueDirectory(WorkQueueDirectory workQueueDirectory) {
