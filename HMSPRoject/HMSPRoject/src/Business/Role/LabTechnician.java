...
import userinterface.LabTechnicianRole.LabTechDetailsJPanel;
...
public class LabTechnician extends Role {
   @Override
    public JPanel createWorkArea(JPanel displayJPanel, UserAccount account, DepartmentClass department, Enterprise enterprise, Ecosystem business) {
       return new LabTechDetailsJPanel(displayJPanel, account, (LabDepartment)department, enterprise,business);
    } 
}
