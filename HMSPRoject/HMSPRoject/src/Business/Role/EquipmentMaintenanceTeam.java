...
import userinterface.EquipmentMaintenaceTeam.equipmentMaintenanceJPanel;

/**
 *
 * @author Ashmita
 */
public class EquipmentMaintenanceTeam extends Role {
    ...
    public JPanel createWorkArea(JPanel displayJPanel, UserAccount account, DepartmentClass department, Enterprise enterprise, Ecosystem business) {
       return new equipmentMaintenanceJPanel(displayJPanel, account, department, enterprise, business);
    }
