 ...
 * @author lsrajput
 */
public class RequestForLabReportsJPanel extends javax.swing.JPanel {
    ...
    public RequestForLabReportsJPanel(JPanel displayJPanel,Ecosystem ecosystem,Patient patient) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Request Lab Reports");

        jLabel2.setText("Patient Id:");

        jLabel3.setText("Lab Incharge");
    ...
    public void populateLabTechnicianComboBox()
    {
        try
        {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int labTechnicianId = Integer.parseInt(n.split(" - ")[0]);
        for(DepartmentClass dep: ecosystem.getNetworkList().get(0).getDepartmentDirectory().getDepartmentList())
        {
            if(dep instanceof LabDepartment)
            {
                for(LabTechnician labTechnician: ((LabDepartment) dep).getLabTechnicianDirectory().getLabTechnicianList())
                {
                    if(labTechnician.getEmployeeId()==labTechnicianId)
                    {
                        patient.setLabTechnicianTask(taskInfo);
                        patient.setLabTechnicianAcknowledged("N");
                        labTechnician.getPatientDirectory().getPatientList().add(patient);
                        break;
                    }
                }
            }
        }
        JOptionPane.showMessageDialog(displayJPanel,"Requested Lab-Incharge Successfully!");
