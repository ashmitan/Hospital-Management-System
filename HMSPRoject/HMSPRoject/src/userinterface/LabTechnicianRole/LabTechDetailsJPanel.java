 ...
 * @author Admin
 */
public class LabTechDetailsJPanel extends javax.swing.JPanel {
    ...
    public LabTechDetailsJPanel(JPanel displayPanel, UserAccount account, DepartmentClass department, Enterprise enterprise,Ecosystem ecosystem) {
        initComponents();
    ...
    private void initComponents() {
        ...
        nurseworkjTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient id", "Patient Name", "Room num", "Required reports", "Doctor", "Acknowledged?"
            }
        ) {
        ...
        if (nurseworkjTable.getColumnModel().getColumnCount() > 0) {
            ...
            nurseworkjTable.getColumnModel().getColumn(5).setResizable(false);
        }
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addGroup(layout.createSequentialGroup()
                                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                            .addComponent(fnamejLabel, javax.swing.GroupLayout.DEFAULT_SIZE, 70, Short.MAX_VALUE)
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addGroup(layout.createSequentialGroup()
                                        .addComponent(dobjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 88, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addGap(18, 18, 18)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(targetteamjComboBox, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(issuedescjLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
...
private void populateSalary() {
      ...
      {
          salaryTextField.setText("20000.00");
      }
      else if(designationjComboBox.getSelectedItem()=="Junior Consultant")
      {
          salaryTextField.setText("22500.00");
      }
      ...
      {
          salaryTextField.setText("40000.00");
      }
    ...
    public void populateTable()
    {
        ...
        {
            if(dept instanceof LabDepartment)
            {
                for(LabTechnician labTech: ((LabDepartment) dept).getLabTechnicianDirectory().getLabTechnicianList())
                {
                    if(labTech.getEmployeeId()==account.getEmployee().getEmployeeId())
                    {
                        for (Patient patient : labTech.getPatientDirectory().getPatientList()){
                                if(patient!=null)
                                {
                                    ...
                                    row[3] = patient.getLabTechnicianTask();
                                    row[4] = patient.getDoctorName();
                                    row[5] = patient.getLabTechnicianAcknowledged();
                                    model.addRow(row);
                                }
                            }
                    }
                    ...
                    for(LabTechnician labTech: ((LabDepartment) dept).getLabTechnicianDirectory().getLabTechnicianList())
                    {
                        if(labTech.getEmployeeId()==account.getEmployee().getEmployeeId())
                        {
                            for (Patient patient : labTech.getPatientDirectory().getPatientList()){
                                ...
                                {
                                    patient.setLabTechnicianAcknowledged("Y");
                                    isDisplayed = true;
                    ...
                    for(LabTechnician labTech: ((LabDepartment) dept).getLabTechnicianDirectory().getLabTechnicianList())
                    {
                        if(labTech.getEmployeeId()==account.getEmployee().getEmployeeId())
                        {
                            for (Patient patient : labTech.getPatientDirectory().getPatientList()){
                                if(patient!=null && patient.getPatientId()==patientId)
                                {
                                    labTech.getPatientDirectory().getPatientList().remove(patient);
                                    isDisplayed = true;
